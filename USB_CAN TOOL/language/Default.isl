...
[LangOptions]
LanguageName=<7B80><4F53><4E2D><6587>(Chinese Simplified)
LanguageID=$0804
...
; *** “选择语言”对话框消息
SelectLanguageTitle=选择安装语言 (Select Setup Language)
SelectLanguageLabel=选择安装时要使用的语言 (Choose the language for installation):
